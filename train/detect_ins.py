...
def get_masks(result, num_classes=17):
...
def parse_args():
    ...
    parser.add_argument('--config', default='./solov2_DCN_robot_detection.py', help='test config file path')
    parser.add_argument('--checkpoint', default='./epoch_36.pth', help='checkpoint file')  # model_DCN_960*540_comparison
    # parser.add_argument('--config', default='./mask_rcnn_robot_detection.py', help='test config file path')
    # parser.add_argument('--checkpoint', default='./mask_rcnn_model/epoch_36.pth', help='checkpoint file')
    parser.add_argument('--out', default='./tmp/result.pkl', help='output result file')
    parser.add_argument(
        '--json_out',
